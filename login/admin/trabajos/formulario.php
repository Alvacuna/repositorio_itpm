...
<body>
    <form action="altatrabajos.php" name="formu" method="POST" class="form" enctype="multipart/form-data" id="form">
        ...
        <div class="form__container">
            ...
            <div>
                <input type="file" name="archivos" accept=".pdf" id="archivos" required>
