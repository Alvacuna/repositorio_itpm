import { getIdCarrera } from "../services/getIdCarrera.js";
...
getIdCarrera(getGET().id).then((data) => {
    users = data.map((user) => {
      ...
      return { titulo: user.titulo, nombre_autor: user.nombreConcat, carrers: user.nombre_carrera,gestion: user.gestion, element: card };
      })
});
